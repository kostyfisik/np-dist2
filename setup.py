...
if os.environ.get("NP_DIST2_COMPILE_MYPYC") == "1":
...
def get_ext_modules():
    ...
    If the `NP_DIST2_COMPILE_MYPYC` environment variable is set to "1",
    ...
    if os.environ.get("NP_DIST2_COMPILE_MYPYC") == "1":
        ...
        # For example:
        # return mypycify([
        #     "src/np_dist2/__main__.py",
        #     "src/np_dist2/some_other_module.py",
        # ])
        return mypycify(
            [
                "src/np_dist2/__main__.py",
